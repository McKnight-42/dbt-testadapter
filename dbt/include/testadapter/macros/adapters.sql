...
{% macro testadapter__alter_column_type(relation,column_name,new_column_type) -%}
...
{% macro testadapter__check_schema_exists(information_schema,schema) -%}
...
{% macro testadapter__drop_relation(relation) -%}
...
{% macro testadapter__drop_schema(relation) -%}
...
{% macro testadapter__get_columns_in_relation(relation) -%}
...
{% macro testadapter__list_relations_without_caching(schema_relation) -%}
'''creates a table of relations withough using local caching.'''
{% endmacro %}

{% macro testadapter__list_schemas(database) -%}
...
{% macro testadapter__rename_relation(from_relation, to_relation) -%}
...
{% macro testadapter__truncate_relation(relation) -%}
...
{% macro testadapter__current_timestamp() -%}
